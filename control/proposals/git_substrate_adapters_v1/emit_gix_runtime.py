...
from git_projection_common import GitProjectionError, command_exists, load_json, normalize_objects, write_json
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        repo_path = str(repo_obj.attributes["repository_ref"]).removeprefix("repo:")
